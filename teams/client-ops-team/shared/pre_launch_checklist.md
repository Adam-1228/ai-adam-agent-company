...
| §14 | commerce handoff importer | **[AUTO]** | `python scripts/preflight_check.py --section 14` + `python scripts/import_commerce_handoff.py <handoff.json>` | `reports/preflight_*.md`, `runtime/commerce_handoffs/qa_queue.md` |
